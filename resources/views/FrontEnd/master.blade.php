                    ...
                    <div class="row vertical-content">
                        <div class="col-lg-7">
                            <div class="home-content mt-4">
                                ...
                                <h2 class="home-title mt-4">A new way to connect simple yet powerful</h2>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    <div class="title-box text-center">
                        <h4 class="title-heading">Application Features</h4>
            ...
            <div class="row mt-5 pt-4">
                <div class="col-lg-4">
                    <div class="text-center mt-4">
                        ...
                        <h4 class="f-19 mt-4">Esay Features</h4>
                        <p class="text-muted mt-4">Corporis suscipit laboriosm aliquid commod suis autemeum iure reprehenderit over voluptate bibendum consequatur.</p>
                    </div>
                </div>
            ...
            <div class="row vertical-content">
                <div class="col-lg-8">
                    <div class="about-content mt-4">
                        <h4 class="about-title text-custom">Easy Task Creation</h4>
                        <p class="about-desc text-muted mt-4">These cases are perfectly simple and easy a distinguish our power choice untrammelled and when nothing prevents our being able to do what we like best every welcomed and every pain avoided which srata capatila stamp undertakes laborious physical exercise except to obtain some advantage from architecto beatae vitae explicabo.</p>
                        ...
                        <div class="row mt-5">
                            <div class="col-lg-4">
                                <div class="mt-4">
                                    ...
                                    <h4 class="mt-3 f-17">Creative Design</h4>
                                    <p class="mt-3 text-muted mb-0">Aliquam diam finibus purus...</p>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="mt-4">
                                    ...
                                    <h4 class="mt-3 f-17">Graphic Design</h4>
                                    <p class="mt-3 text-muted mb-0">Dapibus varius suscipit vitae...</p>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="mt-4">
                                    ...
                                    <h4 class="mt-3 f-17">Ilinstutar</h4>
                                    <p class="mt-3 text-muted mb-0">Vestibulum ante ipsum primis...</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mt-4">
                            <div class="col-lg-4">
                                <div class="mt-4">
                                    ...
                                    <h4 class="mt-3 f-17">Web Design</h4>
                                    <p class="mt-3 text-muted mb-0">Etiam malesuada laore elit...</p>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="mt-4">
                                    ...
                                    <h4 class="mt-3 f-17">User Friendly</h4>
                                    <p class="mt-3 text-muted mb-0">Mauris pretium fermtum metus...</p>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="mt-4">
                                    ...
                                    <h4 class="mt-3 f-17">4/7 Support</h4>
                                    <p class="mt-3 text-muted mb-0">Maecenas id ipsum rutrum...</p>
                                </div>
                            </div>
                        </div>
    ...
    <section class="section">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    <div class="title-box text-center">
                        <h4 class="title-heading">Awesome Screenshort</h4>
                        <p class="title-desc text-muted mt-4">Temporibus autem quibusdam officiis debitis necessitatibus eveniet voluptates repudiandae molestiae non recusandae taque earum rerum hic asperiores repellat.</p>
                        <div class="title-border mt-5">
                            <span class="title-icon">
                                <i class="pe-7s-angle-down"></i>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="video-box text-center">
                        ...
                        <h5 class="text-uppercase text-white mt-5">Aparax Watch Video</h5>
                        <h3 class="video-title mt-5 text-white line-height_1_4 mb-0">Best app in the market available now</h3>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="section">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    <div class="title-box text-center">
                        <h4 class="title-heading">frequently Asked Questions</h4>
                        <p class="title-desc text-muted mt-4">Temporibus autem quibusdam officiis debitis necessitatibus eveniet voluptates repudiandae molestiae non recusandae taque earum rerum hic asperiores repellat.</p>
                        <div class="title-border mt-5">
                            <span class="title-icon">
                                <i class="pe-7s-angle-down"></i>
